...
class BinaryTree():
    ...
    def print_tree(self, traversal_type):
        ...
        reference on how to write recursive functions on recursive
        data structures.
        '''
        if traversal_type == 'preorder':
            ...
            raise ValueError('TrvType' + str(traversal_type) + 'nt supportd.')
    ...
    def to_list(self, traversal_type):
        ...
        A general programming principle is that a func should ret its results
        ...
        Many of the test cases for more complicated tree functions
        rely on this to_list function,
        ...
        if traversal_type == 'preorder':
            ...
            raise ValueError('TravType ' + str(traversal_type) + 'nt supportd')
    ...
    def __len__helper(node):
        ...
        if a left child, add the result of __len__helper on the left child;
    ...
    def _height(node):
        ...
        if node is None:
            return -1
        leftheight = BinaryTree._height(node.left)
        rightheight = BinaryTree._height(node.right)
